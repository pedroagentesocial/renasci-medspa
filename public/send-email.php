...
$logoUrl = $host !== '' ? "{$scheme}://{$host}/logo/Renasci-logo.png" : '/logo/Renasci-logo.png';
if (is_array($data)) {
...
$smtpFrom = getenv('SMTP_FROM') ?: 'noreply@renasci.com';
$smtpFromName = getenv('SMTP_FROM_NAME') ?: 'Renasci Medical Spa';
...
$companyTexts = [
    'en' => [
        ...
        'intro' => 'You have received a new message from the Renasci Medical Spa website. Below are the details:'
    ],
    'es' => [
        'title' => 'Nuevo Mensaje de Contacto',
        'intro' => 'Has recibido un nuevo mensaje desde el sitio Renasci Medical Spa. A continuación los detalles:'
    ]
];
...
<head>
    ...
    <style>
        ...
        .header {
            background: linear-gradient(135deg, #AABFA8 0%, #8FA48C 100%);
            color: white;
            padding: 40px 20px;
            text-align: center;
        }
...
<body>
    <div class="container">
        <div class="header">
            <img src="{$logoUrl}" alt="Renasci Medical Spa">
            <h1>{$ct['title']}</h1>
        </div>
        ...
        <div class="content">
            ...
            <p style="font-size: 14px; color: #999; margin: 0;">
                <strong>Submission Date:</strong> {$submissionDate} (UTC)
            </p>
        </div>
        ...
        <div class="footer">
            <p>
                ...
                <strong>Renasci Medical Spa</strong><br>
                <a href="mailto:pedro@agentesocial.com">pedro@agentesocial.com</a>
            </p>
        </div>
    </div>
</body>
...
$subjectCompany = $language === 'es' ? "Nuevo mensaje de contacto - Renasci Medical Spa" : "New contact message - Renasci Medical Spa";

// Configurar headers para enviar email en HTML
$headers = "MIME-Version: 1.0\r\n";
$headers .= "Content-type: text/html; charset=UTF-8\r\n";
$headers .= "From: noreply@renasci.com\r\n";
...
$clientTexts = [
    'en' => [
        ...
        'thankYou' => 'Thank you for contacting Renasci Medical Spa. We are committed to providing exceptional care and personalized treatments.',
    ...
    'es' => [
        ...
        'thankYou' => 'Gracias por contactar a Renasci Medical Spa. Estamos comprometidos con tu bienestar y atención personalizada.',
...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <h3 style="color: #8FA48C; margin-top: 30px;">{$texts['info_title']}</h3>
            ...
            <p style="font-size: 14px; color: #666; margin-top: 30px; line-height: 1.6;">
                {$texts['contact_text']} <a href="mailto:pedro@agentesocial.com">pedro@agentesocial.com</a>
            </p>
        </div>
...
$clientHeaders .= "From: noreply@renasci.com\r\n";

// Enviar email de confirmación al cliente
$clientSubject = $language === 'es' ? "Confirmación de envío - Renasci Medical Spa" : "Form Submission Confirmed - Renasci Medical Spa";
$mailToClient = null;
if ($email !== '') {
